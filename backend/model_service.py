...
MODEL_PATH = PROJECT_ROOT / "models" / "pm25_24h_best.joblib"
METADATA_PATH = PROJECT_ROOT / "models" / "pm25_24h_best_metadata.json"
...
# These fields are useful to people browsing the app even when the selected
# model excludes weather after feature ablation.
